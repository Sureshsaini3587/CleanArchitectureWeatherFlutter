...
class WeatherDetailsGridView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final weatherViewState =
        ref.watch(WeatherViewProvider.weatherViewControllerProvider);
    final AllWeatherInfoDTO? allWeatherInfoDTO =
        weatherViewState.allWeatherInfoDTO;
    ...
    return GridView.count(
      crossAxisCount: isPortraitMode
          ? AppDimensions.weatherDetailGridViewPortraitCellSize
          : AppDimensions.weatherDetailGridViewLandscapeCellSize,
      children: <Widget>[
        if (allWeatherInfoDTO.name != null)
          AdvancedWeatherDetailsCard(
            ...
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.temp != null &&
            allWeatherInfoDTO.weather?.isNotEmpty == true &&
            allWeatherInfoDTO.weather?.first?.type != null)
          AdvancedWeatherDetailsCard(
            icon: allWeatherInfoDTO.weather!.first!.type!.weatherIcon,
            title: ref.translateText(textType: TextType.temperature),
            subtitle: (allWeatherInfoDTO.main?.temp?.toString() ??
                    AppStrings.unknownText) +
                ref.translateText(textType: TextType.celsius),
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.feelsLike != null &&
            allWeatherInfoDTO.main?.temp != null &&
            allWeatherInfoDTO.weather?.isNotEmpty == true &&
            allWeatherInfoDTO.weather?.first?.type != null)
          AdvancedWeatherDetailsCard(
            icon: allWeatherInfoDTO.weather!.first!.type!.weatherIcon,
            title: ref.translateText(textType: TextType.temperatureFeelsLike),
            subtitle: (allWeatherInfoDTO.main?.feelsLike?.toString() ??
                    AppStrings.unknownText) +
                ref.translateText(textType: TextType.celsius),
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.tempMin != null &&
            allWeatherInfoDTO.main?.temp != null &&
            allWeatherInfoDTO.weather?.isNotEmpty == true &&
            allWeatherInfoDTO.weather?.first?.type != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle: (allWeatherInfoDTO.main?.tempMin?.toString() ??
                    AppStrings.unknownText) +
                ref.translateText(textType: TextType.celsius),
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.tempMax != null &&
            allWeatherInfoDTO.main?.temp != null &&
            allWeatherInfoDTO.weather?.isNotEmpty == true &&
            allWeatherInfoDTO.weather?.first?.type != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle: (allWeatherInfoDTO.main?.tempMax?.toString() ??
                    AppStrings.unknownText) +
                ref.translateText(textType: TextType.celsius),
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.wind?.speed != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle:
                '${allWeatherInfoDTO.wind?.speed?.toString() ?? AppStrings.unknownText} (${ref.translateText(textType: TextType.windSpeedMagnitude)})',
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.humidity != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle:
                '${allWeatherInfoDTO.main?.humidity?.toString() ?? AppStrings.unknownText} (${ref.translateText(textType: TextType.percentage)})',
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.pressure != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle:
                '${allWeatherInfoDTO.main?.pressure?.toString() ?? AppStrings.unknownText} (${ref.translateText(textType: TextType.pressureMagnitude)})',
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.seaLevel != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle:
                '${allWeatherInfoDTO.main?.seaLevel?.toString() ?? AppStrings.unknownText} (${ref.translateText(textType: TextType.pressureMagnitude)})',
            path: RouterType.accountList.absolutePath,
          ),
        if (allWeatherInfoDTO.main?.grndLevel != null)
          AdvancedWeatherDetailsCard(
            ...
            subtitle:
                '${allWeatherInfoDTO.main?.grndLevel?.toString() ?? AppStrings.unknownText} (${ref.translateText(textType: TextType.pressureMagnitude)})',
            path: RouterType.accountList.absolutePath,
          ),
      ],
    );
