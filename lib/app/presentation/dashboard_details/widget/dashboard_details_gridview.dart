...
class DashboardDetailsGridView extends ConsumerWidget {
  const DashboardDetailsGridView({super.key});
    ...
    return GridView.count(
      ...
      children: <Widget>[
        AdvancedWeatherDetailsCard(
          ...
          title: ref.translateText(textType: TextType.recurringDeposit),
          subtitle: ref.translateText(textType: TextType.noOfRecurringDeposit),
          path: RouterType.accountList.absolutePath,
        ),

        AdvancedWeatherDetailsCard(
          icon: AppIcons.humidityIcon,
          title: ref.translateText(textType: TextType.fixedDeposit),
          subtitle: ref.translateText(textType: TextType.noOfFixedDeposit),
          path: RouterType.accountList.absolutePath,
        ),
        if (allWeatherInfoDTO.name != null)
          AdvancedWeatherDetailsCard(
            icon: AppIcons.seaLevelPressureIcon,
            title: ref.translateText(textType: TextType.loan),
            subtitle: ref.translateText(textType: TextType.numberOfLoanAccount),
            path: RouterType.accountList.absolutePath,
          ),
